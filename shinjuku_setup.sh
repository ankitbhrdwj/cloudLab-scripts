...
apt-get --assume-yes install libgnutls30 libgnutls-openssl-dev \
        libcurl4-gnutls-dev libnuma-dev libpcap-dev clang numactl libconfig-dev libnuma-dev
...
kernel_boot_params="default_hugepagesz=2M hugepagesz=2M hugepages=8192"
